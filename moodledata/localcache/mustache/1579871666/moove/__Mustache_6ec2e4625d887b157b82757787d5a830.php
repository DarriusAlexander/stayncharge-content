...
class __Mustache_6ec2e4625d887b157b82757787d5a830 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="nav-drawer-footer">
';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '               class="iclon slicon-settings">
';
        $buffer .= $indent . '            </i>
';
